        ...
        <div class="modal-body p-5 pt-0">
          ...
          <?php include $this->resolve('partials/_csrf.php'); ?>
            <div class="form-floating mb-3">
              <!--<input type="text" class="form-control rounded-3" id="loginFloatingName" name="login" php= isset($_SESSION['bad_attempt']) ? 'value="'.$_SESSION['bad_attempt'].'"' : '' ?>>-->
			  <input type="text" class="form-control rounded-3" id="emailFloatingName" placeholder="e-mail" name="email"  value="<?php echo e($oldFormData['email'] ?? ''); ?>">
