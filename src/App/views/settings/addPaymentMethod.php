...
<!-- Subpage AddPayment -->
  ...
  <div class="text-start p-5 py-3 mb-2 border-bottom-0">
    <p class="fw-bold mb-0 fs-2">Dodaj nową metodę płatności: </p>
  </div>
    ...
    <form method="POST" action="/addPaymentMethod">
      ...
      <div class="form-floating mb-3">
        <input 
          ...
          value="<?= e($oldFormData['paymentMethod'] ?? '') ?>"
        >
        <label for="registerFloatingInput">Dodaj nową metodę płatności:</label>
