...
<!-- Subpage AddPaymentMethods -->

  <div class="text-start p-0 p-md-2 py-0 mb-1 border-bottom-0">
    <p class="fw-bold mb-0 fs-2">Edytuj metody płatności: </p>
  </div>
        
  <div class="p-0 p-md-5 py-0 fs-5">

                     <div class="container tablePayments table-responsive">
					...
					<tbody>
					<?php foreach ($paymentMethod as $i => $row): ?>
					<tr>
                    ...
                    <td class="text-end">
                            ...
                            <div class="d-flex justify-content-evenly">
                                  ...
                                  <a href="/editPaymentMethod/<?= e($row['id_user_pay_met']) ?>"
                              ...
                              <input type="hidden" name="id_cat" value="<?= $row['id_user_pay_met']?>" />
                    ...
                    <tfoot>
                      <tr>
                        <th></th>
                        <th class="text-center">Ilość Twoich metod płatności: </th>
						 <th class="text-center"><?= $paymentMethodCount ?></th>      
