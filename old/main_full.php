...
if(!isset($_SESSION['logged_id'])){
	...
	if(isset($_POST['login'])){
		...
		$userQuery =  $db->prepare('SELECT id_user, user_password FROM users WHERE user_login = :login');
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse d-lg-flex" id="buttonNavbar">
            ...
            <ul class="navbar-nav col-lg-9 justify-content-lg-end">
              ...
              <li class="nav-item">
                <a class="btn btn-lg btn-outline-primary m-1" href="./bilans.html">Aktualny bilans</a>
              </li>              
      ...
      <div class="container col-12 col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
         ...
         <div class="col-10 col-sm-8 col-lg-4">
           <p class="display-6 text-body-emphasis lh-1 mb-0 text-left">Witaj Aleksandrze!</p>
            <div class="col-12 col-sm-10 col-lg-10">
              <p class="lead text-left py-4">Dane z aktualnego miesiąca:</p>
                ...
                <div class="row">
                  ...
                  <div class="col">
                  <p class="lead fw-bold text-end">2912,25 PLN</p>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <p class="lead fw-bold text-end">12825,95 PLN</p>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <p class="lead fw-bold text-success text-end">9913,70 PLN</p>
                  </div>
                </div>
